{
  flake.modules.nixvim.snacks = {
    ...
    keysTerminal = mkKeyMapIf (cfg.enable && cfg.settings.terminal.enabled) [
      {
        action.__raw = ''
          function()
    ...
    keysBufDel = mkKeyMapIf (cfg.enable && cfg.settings.bufdelete.enabled) [
      {
        action.__raw = ''
          function()
      ...
      (mkKeyMap
        [
          ...
          }
          {
            ...
            '';
            key = "<leader>fd";
            options.desc = "Picker: Lsp symbols";
          }
          {
            action.__raw = ''
              function()
            ...
            '';
            key = "<leader>fD";
            options.desc = "Picker: Lsp references";
          }
          {
            action.__raw = ''
              function()
            ...
            '';
            key = "<leader>fi";
            options.desc = "Picker: Lsp implementations";
          }
          {
            action.__raw = ''
              function()
            ...
            '';
            key = "<leader>fi";
            options.desc = "Picker: Lsp definitions";
          }
        ]
